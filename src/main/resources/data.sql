...
insert into category(name) values ('Project_1');
...
insert into entry(check_in, check_out, confirmed, application_user_id, category_id) VALUES ('20201212', '20201213', false, 1, 1);
/* Add new Administrator Entry */
insert into entry(check_in, check_out, confirmed, application_user_id, category_id) VALUES ('20201214', '20201216', false, 2, 1);
